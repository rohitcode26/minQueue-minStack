...
/*
Implementation of a Queue data structure that supports insertion at the back 
of the queue, removal from the front and get Minimum element currently in the 
queue all in amortized O(1) time.
*/
...
class MinQueue
{
    ...
    private:
        ...
        /*
          auxiliary function that transfer elements from
...
void MinQueue<T> :: pop() {
    ...
    //element at the top of Front represents the head element of the queue.
